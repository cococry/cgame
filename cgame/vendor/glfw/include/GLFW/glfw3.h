...
/* It is customary to use __stdcall for OpenGL function pointer declarations on
 * all platforms.  Additionally, the Windows OpenGL header needs __stdcall.
 */
#if !defined(APIENTRY)
#define GLFW___stdcall_DEFINED
#endif /* __stdcall */
